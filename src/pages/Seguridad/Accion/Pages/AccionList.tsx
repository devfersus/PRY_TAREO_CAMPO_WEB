...
export const AccionLista = ({ acciones, onEditar, puedeEditar, cargandoEditar }: Props) => {
  return (
            ...
            <TableRow key={accion.id} hover>
              ...
              {puedeEditar && (
                <TableCell align="center">
                  <IconButton size="small" color="primary" disabled={cargandoEditar} onClick={() => onEditar(accion)}>
                    {cargandoEditar
