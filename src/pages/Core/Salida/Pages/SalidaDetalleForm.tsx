...
import type { ISalidaDetalleItem, ISalidaDetalleListItem } from '../interface/ISalidaDetalle.interface';
import { createSalidaDetalleMasivo } from '../api/createSalidaDetalle.action';
...
export const SalidaDetalleForm = ({ salida, onGuardar, onCancel }: Props) => {
    const [items, setItems]                           = useState<ISalidaDetalleItem[]>([]);
    const [detallesExistentes, setDetallesExistentes] = useState<ISalidaDetalleListItem[]>([]);
    ...
    const handleGuardar = async () => {
        ...
        setIsPending(true);
        try {
            await createSalidaDetalleMasivo({
